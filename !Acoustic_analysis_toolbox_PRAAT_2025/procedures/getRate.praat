...
# Add to table
				...
				if "'speakingrate'" = "--undefined--"
					Set string value... table_row_counter speakingrate "NA"
					Set string value... table_row_counter articulationrate "NA"
					Set string value... table_row_counter npause "NA"
					Set string value... table_row_counter asd "NA"
				else
					Set string value... table_row_counter speakingrate 'speakingrate:2'
					Set string value... table_row_counter articulationrate 'articulationrate:2'
					Set string value... table_row_counter npause 'npause'
					Set string value... table_row_counter asd 'asd:3'
				endif
